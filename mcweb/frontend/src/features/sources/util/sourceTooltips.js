...
export default function sourceTooltips() {
	...
	pub_country: "The primary country this Source is publishing from or where their headquarters are located (in 3-letter ISO 3166-1 alpha-3 standard format).",

	pub_state: "The primary state or province this Source is publishing from or where their headquarters are located (in ISO 3166-2 standard format).",

	primary_language: `Our system guesses the primary language of each article it ingests. For each Source we indicate the language the plurality of its articles are in, if we have enough to measure (${updated('primary_language', 'weekly')}).`,
