...
CONSTANCE_CONFIG = {
    ...
    "SOURCE_ALERT_USE_PELT": (False, "Sources: use PELT regime summaries instead of legacy threshold alerts", bool),
    "SYSTEM_ALERT": ("", "System alert message to show to users (set to empty string to disable)", "long_text"),
}

CONSTANCE_CONFIG_FIELDSETS = {
    "Monitoring Options": ("REQUEST_LOGGING_ENABLED", "LOG_RAW_QUERY_ENABLED", "SOURCE_ALERT_USE_PELT"),
