    ...
    def validate(self, password, user=None):
        ...
        if count < self.minimum_amount_of_numbers:
            raise ValidationError(
                _("This password must contain at least %(minimum_amount_of_numbers)d numbers."),
...
class SpecialCharacters:
    ...
    def validate(self, password, user=None):
        ...
        if count < self.minimum_amount_of_special_characters:
            raise ValidationError(
                _("This password must contain at least %(minimum_amount_of_special_characters)d special characters."),
                code="requires_more_numbers",
    ...
    def get_help_test(self):
        return _(
            "Your password must contain at least %(minimum_amount_of_special_characters)d special characters."
