    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(choices=[(backend.sources.models.ServiceNames['OnlineNews'], 'online_news'), (backend.sources.models.ServiceNames['YouTube'], 'youtube')], max_length=100)),
